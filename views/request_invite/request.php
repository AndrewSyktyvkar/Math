    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-lg-offset-4 col-md-5 col-md-offset-4 col-sm-7 col-sm-offset-3 col-xs-12">
          ...
          <form name="req_form" method="post">
            <div class="jumbotron">
              ...
              <label for="message"> Почему я должен быть автором</label>
              <input type="text" class="form-control" name="message" placeholder="Почему я должен быть автором">  
